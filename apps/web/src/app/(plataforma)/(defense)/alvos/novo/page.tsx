      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <section className="form-section">
          ...
          <EntitySearchSelect<Case>
            label="Vincular a casos existentes (busque pelo nome)"
            ...
            isSelected={c => caseLinks.some(l => l.caseId === c.id)}
            onSelect={c => setCaseLinks(prev => [...prev, { caseId: c.id, name: c.name, role: "outro" }])}
          />
